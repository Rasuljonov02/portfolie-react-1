  ...
  return (
    <>
      <div className="m-0 p-0">
        ...
        <div id="front" className="mt-[100px]">
          <div className="bg-[#252525] w-full h-[150px]  flex items-center justify-start pl-[60px] pr-[60px]">
            <h1 data-aos="fade-up" data-aos-anchor-placement="top-center" className="end ">
              Front-end skills
            </h1>
          </div>
          <div className=" flex mt-10 items-center w-full pl-[60px] pr-[60px] pb-10 justify-between">
              ...
              <div className=" flex flex-col gap-4">
                <div className="flex gap-2 items-start text-white w-[600px] ">
                  ...
                  <span>
                    ...
                    <p className="UX">I am a creative UI/UX designer, skilled in making user experience more complex and meaningful. I play to find innovative approaches to design, structured according to the latest developments in technology.</p>
                  </span>
                </div>
                <div className="flex gap-2 items-start text-white w-[600px]">
                  <img src={kom} alt="" />
                  <span>
                    ...
                    <p className="UX">Proficiency in HTML, CSS, and JavaScript is abundant in creating quality websites We have years of experience. Open sites, image and location information edit, add animations, and interact with users we have skills in achieving communication.</p>
                  </span>
                </div>
                <div className="flex gap-2 items-start text-white w-[600px] ">
                  <img src={dom} alt="" />
                  <span>
                    ...
                    <p className="UX">I have extensive experience in Sass, GreenSock (GSAP), and React technologies. I am highly skilled in facilitating styling with Sass, powering animations with GSAP, and creating interactive components with React.</p>
                  </span>
                </div>
              </div>
            </div>
                ...
                {skills.map((skill, index) => (
                  <div key={index} className="flex flex-col gap-5 ">
                    <span className="w-[350px] flex justify-between items-center">
                      ...
                      <h3 id={`percentage-text-${index}`} className="foyiz text-white percentage-text">
                        {skill.percentage}%
                      </h3>
                    </span>
                    <div className="w-[350px] h-[7px] bg-slate-100 rounded-xl">
                      <p id={`progress-bar-${index}`} className="w-[200px] h-[7px] bg-[#007CED] progress-bar rounded-xl"></p>
                    </div>
                  </div>
                ))}
              </div>
